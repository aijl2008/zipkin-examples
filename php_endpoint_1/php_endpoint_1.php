...
$childSpan->setName(basename(__FILE__) . ':' . __LINE__);
...
$nextUrl = $_GET["nextUrl"] ?: 'http://localhost:7011';
echo "[" . posix_getpid() . "]TraceId:" . $childSpan->getContext()->getTraceId() . PHP_EOL;
echo "[" . posix_getpid() . "]ParentId:" . $childSpan->getContext()->getParentId() . PHP_EOL;
echo "[" . posix_getpid() . "]SpanId:" . $childSpan->getContext()->getSpanId() . PHP_EOL;
